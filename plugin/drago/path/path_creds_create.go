...
// maxTokenNameLength is the maximum length for the name of a Drago access token
const maxTokenNameLength = 256

func CreateCreds(b drago.DragoBackend) *framework.Path {
...
func (b *backend) ReadToken(ctx context.Context, req *logical.Request, d *framework.FieldData) (*logical.Response, error) {
